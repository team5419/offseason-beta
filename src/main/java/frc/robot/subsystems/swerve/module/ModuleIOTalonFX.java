...
public class ModuleIOTalonFX implements ModuleIO {
    ...
    public ModuleIOTalonFX(
        ...
        driveTalon = new TalonFX(constants.DriveMotorId, GlobalConstants.kCANivoreName);
        turnTalon = new TalonFX(constants.SteerMotorId, GlobalConstants.kCANivoreName);
        cancoder = new CANcoder(constants.EncoderId, GlobalConstants.kCANivoreName);
        ...
        BaseStatusSignal.setUpdateFrequencyForAll(SwerveConstants.kOdometryFreq, drivePosition, turnPosition);
