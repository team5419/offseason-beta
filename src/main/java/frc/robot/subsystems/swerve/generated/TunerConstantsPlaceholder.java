...
public class TunerConstantsPlaceholder {
    ...
    private static final Slot0Configs driveGains =
            new Slot0Configs().withKP(0.1).withKI(0).withKD(0).withKS(0.1).withKV(0.8);

    // .8 works the best so far
    ...
    public static final LinearVelocity kSpeedAt12Volts = FeetPerSecond.of(18.5);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.463623046875);
